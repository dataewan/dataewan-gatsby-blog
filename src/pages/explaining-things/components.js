      ...
      <article>
        ...
        <Section name='Figure component'>
          <Paragraph>
            ...
            If <span class='mono'>fullwidth</span> is set to anything other than
            <span class='mono'>{true}</span> (the curly brackets are important),
            then the figure will be flush with the text.
            If it is set to true then the figure will take up the whole width of the page.
            Put your <span class='mono'>img</span> tags in the figure to have the content show up.
            <Code language="javascript" code={
              `
              <Figure 
                fullwidth={true}
